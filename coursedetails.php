...
?>  
    <div class="container-fluid bg-dark"> <!-- Start Course Page Banner -->
      <div class="row">
        <img src="image/cousebanner.jpg" alt="courses" style="height:200px; width:100%; object-fit:cover; box-shadow:10px;"/>
      </div> 
            ...
            while($row = $result->fetch_assoc()){
              echo ' 
                ...
                <div class="col-md-4">
                  ...
                  <a class="btn btn-primary" href="./preview/popup.html" onclick="toggle();">Preview</a>
                </div>
                <div class="col-md-8">
                  <div class="card-body">
