...
<body>
   ...
   <div class="container-fluid bg-success p-2" >
    ...
    <a class="btn btn-primary mr-2" href="./myCourse.php">My Courses</a>
    <a class="btn btn-danger mr-2" href="../Quiz/index.html">Exercise</a>
    <a class="btn btn-primary " href="../Certificate1/form_certificate.php">Get Certificate</a>
   </div>
